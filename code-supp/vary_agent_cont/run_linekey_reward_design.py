...
def calculate_PBRS_orig(env_orig, env_abstr, n_times_state_piced=10,
    ...
    T, R = linekey_abstraction.get_sampling_T_ground(env_orig, n_times_state_piced, n_times_action_picked)
    reward_PBRS = {}
...
if __name__ == "__main__":
    ...
    env = linekey_env_cont.discreteEnv(env_args)
    env_orig = linekey_abstraction.discreteEnv(env, epsilon_net=epsilon_net, num_traj=0, len_traj=500)
    for key in env_args:
    ...
    _, PBRS_cont = calculate_PBRS_orig(env, env_orig, n_times_state_piced=5,
                        n_times_action_picked=5)
    # print(PBRS_cont)
    # exit(0)
    ...
    write_into_file(accumulator_for_file, exp_iter=1, out_folder_name="designed_rewards_chain_key_const_middle",
