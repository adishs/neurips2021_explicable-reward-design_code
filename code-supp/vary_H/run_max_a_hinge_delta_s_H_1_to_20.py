...
if __name__ == "__main__":
    ...
    H_set = range(1, 21) #get_H_set(env_orig) # (1/1-gamma)//2, ...., 1/(1-gamma)
    ...
    write_into_file(accumulator_for_file, exp_iter=1, out_folder_name="designed_rewards_room_max_a_hinge_delta_s_H_1_to_20",
