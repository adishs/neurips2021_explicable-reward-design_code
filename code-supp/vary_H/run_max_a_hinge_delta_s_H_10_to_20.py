...
from reward_design_hinge.reward_design_optimization_model_sub_optimal_IR_max_a_hinge_delta_s import *
...
if __name__ == "__main__":
    ...
    H_set = range(10, 21) #get_H_set(env_orig) # (1/1-gamma)//2, ...., 1/(1-gamma)
    ...
    # print(np.min(delta_s_a_array_orig))
    # print(np.linalg.norm(get_delta_s_given_delta_s_a(delta_s_a_array_orig, pi_target_d, pi_target_s)-
    #                      np.array(get_delta_s_given_policy(env_orig, pi_target_d, pi_target_s, tol=tol))))
    # exit(0)
    ...
    # heatmap_polot_room.plotting(accumulator_for_file, folder_name="max_a_hinge_delta_s", color_ranges=4)
    write_into_file(accumulator_for_file, exp_iter=1, out_folder_name="designed_rewards_room_max_a_hinge_delta_s_H_10_to_20",
