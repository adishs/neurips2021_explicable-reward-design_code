...
if __name__ == "__main__":
    ...
    settings = ['10.a', '10.b', '10.c']

    parser = argparse.ArgumentParser(description='Arguments for Plots : Figure, Number of average')
    ...
    if figure == '10.a':
        setting_to_run = 'max_a_hinge_delta_s_H_2_power'

    if figure == '10.b':
        setting_to_run = 'max_a_hinge_delta_s_H_1_to_20'

    if figure == "10.c":
        setting_to_run = 'max_a_hinge_delta_s_H_10_to_20'
