...
if __name__ == "__main__":
    ...
    # heatmap_polot_room.plotting(accumulator_for_file, folder_name="sum_a_hinge_delta_s", color_ranges=4)
    write_into_file(accumulator_for_file, exp_iter=1, out_folder_name="designed_rewards_room_sum_a_hinge_delta_s",
