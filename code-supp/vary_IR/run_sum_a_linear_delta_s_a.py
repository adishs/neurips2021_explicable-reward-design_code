...
from reward_design.reward_design_optimization_model_sub_optimal_IR_sum_a_linear_delta_s_a import *
...
if __name__ == "__main__":
    ...
    write_into_file(accumulator_for_file, exp_iter=1, out_folder_name="designed_rewards_room_sum_a_linear_delta_s_a",
