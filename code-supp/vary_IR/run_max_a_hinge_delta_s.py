...
from reward_design.reward_design_optimization_model_sub_optimal_IR_max_a_hinge_delta_s import *
...
if __name__ == "__main__":
    ...
    write_into_file(accumulator_for_file, exp_iter=1, out_folder_name="designed_rewards_room_max_a_hinge_delta_s",
