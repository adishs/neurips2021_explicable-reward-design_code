...
if __name__ == "__main__":
    ...
    os.system('python run_linekey_reward_design.py')
    print(" Reward design ended ...")


    #Q-learning on designed rewards
    print(" Q-learning  started ...")
    os.system('python run_linekey_q_learning.py {}'.format(n_average))
    print(" Q-learning  ended ...")

    #Plot Q-learning Data
    print(" Plotting started ...")
    os.system('python linekey_plottingscript.py {}'.format(n_average))
    print(" Plotting end ...")
