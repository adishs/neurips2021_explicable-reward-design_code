...
def reward_design_model_based(env_0,  pi_d, pi_s, R_max, H_set, s_active =None,
                    delta_s_array=None, C_1=1, C_2=0, dict_s_opt_actions_arr=None,
...
def get_important_states_by_shaping(env_orig, pi_d, pi_s, R_max, H_set, s_active=None,
    ...
    obj_value, R_shaped = reward_design_model_based(env_orig, pi_d=pi_d, pi_s=pi_s, R_max=R_max, H_set=H_set,
    ...
    accumulator_for_file["R_{}_env={}_n_states={}_len_active_set_chosen={}".format(exp_name, env_name, n_states,
                                                                   len(s_active_set_chosen))] = R_shaped.flatten()
    ...
    return s_active_set_chosen, R_shaped, accumulator_for_file
# enddef
